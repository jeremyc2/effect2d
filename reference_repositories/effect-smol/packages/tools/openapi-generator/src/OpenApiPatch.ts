 ...
 * @category errors
 */
export class JsonPatchParseError extends Schema.ErrorClass(
	"JsonPatchParseError",
)({
 ...
 * @category errors
 */
export class JsonPatchValidationError extends Schema.ErrorClass(
 ...
 * @category errors
 */
export class JsonPatchApplicationError extends Schema.ErrorClass(
 ...
 * @category errors
 */
export class JsonPatchAggregateError extends Schema.ErrorClass(
