 ...
 * @category Services
 */
export class OtelTracer extends ServiceMap.Service<OtelTracer, Otel.Tracer>()(
...
const makeOtelSpan = (span: Tracer.Span, clock: Clock.Clock): Otel.Span => {
	...
	const self: Otel.Span = {
		...
		addEvent(name) {
			let attributes: Otel.Attributes | undefined;
			let startTime: Otel.TimeInput | undefined;
