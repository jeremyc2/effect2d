 ...
 * @category references
 */
export const Scheduler: ServiceMap.Reference<Scheduler> =
	ServiceMap.Reference<Scheduler>("effect/Scheduler", {
 ...
 * @category references
 */
export const PreventSchedulerYield = ServiceMap.Reference<boolean>(
