 ...
 */
export const empty = <K, V>(): Effect.Effect<
	TxHashMap<K, V>,
	never,
	Effect.Transaction
> =>
 ...
 * @category combinators
 */
export const size = <K, V>(
	self: TxHashMap<K, V>,
): Effect.Effect<number, never, Effect.Transaction> =>
	Effect.gen(function* () {
		const map = yield* TxRef.get(self.ref);
 ...
 * @category combinators
 */
export const keys = <K, V>(
	self: TxHashMap<K, V>,
): Effect.Effect<Array<K>, never, Effect.Transaction> =>
	Effect.gen(function* () {
		const map = yield* TxRef.get(self.ref);
 ...
 * @category combinators
 */
export const values = <K, V>(
	self: TxHashMap<K, V>,
): Effect.Effect<Array<V>, never, Effect.Transaction> =>
	Effect.gen(function* () {
		const map = yield* TxRef.get(self.ref);
...
export const snapshot = <K, V>(
	self: TxHashMap<K, V>,
): Effect.Effect<HashMap.HashMap<K, V>, never, Effect.Transaction> =>
	TxRef.get(self.ref);
...
export const toValues = <K, V>(
	self: TxHashMap<K, V>,
): Effect.Effect<Array<V>, never, Effect.Transaction> => values(self);
