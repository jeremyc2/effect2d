 ...
 * @since 4.0.0
 */
export const CurrentConcurrency = ServiceMap.Reference<"unbounded" | number>(
 ...
 * @category references
 */
export const CurrentStackFrame = ServiceMap.Reference<StackFrame | undefined>(
 ...
 * @category references
 */
export const TracerTimingEnabled = ServiceMap.Reference<boolean>(
 ...
 * @category references
 */
export const TracerSpanAnnotations = ServiceMap.Reference<
 ...
 * @category references
 */
export const TracerSpanLinks = ServiceMap.Reference<ReadonlyArray<SpanLink>>(
 ...
 * @category references
 */
export const CurrentLogAnnotations = ServiceMap.Reference<
	ReadonlyRecord<string, unknown>
 ...
 * @since 4.0.0
 */
export const CurrentLogLevel: ServiceMap.Reference<Severity> =
	ServiceMap.Reference<Severity>("effect/References/CurrentLogLevel", {
		defaultValue: () => "Info",
	});
 ...
 * @since 4.0.0
 */
export const MinimumLogLevel = ServiceMap.Reference<LogLevel>(
 ...
 * @since 4.0.0
 */
export const UnhandledLogLevel: ServiceMap.Reference<Severity | undefined> =
	ServiceMap.Reference("effect/References/UnhandledLogLevel", {
