 ...
 * ```
 */
export class ParentSpan extends ServiceMap.Service<ParentSpan, AnySpan>()(
	ParentSpanKey,
) {}
 ...
 * @since 4.0.0
 */
export const CurrentTraceLevel: ServiceMap.Reference<LogLevel> =
	ServiceMap.Reference<LogLevel>("effect/Tracer/CurrentTraceLevel", {
		defaultValue: () => "Info",
	});
 ...
 * @since 4.0.0
 */
export const MinimumTraceLevel = ServiceMap.Reference<LogLevel>(
 ...
 * ```
 */
export const Tracer: ServiceMap.Reference<Tracer> =
	ServiceMap.Reference<Tracer>(TracerKey, {
		defaultValue: () =>
			make({
