 ...
 * @category Yieldable
 */
export abstract class YieldableClass<A, E = never, R = never>
	implements Yieldable<any, A, E, R>
{
...
export declare namespace Yieldable {
	 ...
	 */
	export type Success<T> =
		T extends Yieldable<infer _Self, infer _A, infer _E, infer _R> ? _A : never;
}
...
export const gen: {
	<Eff extends Yieldable<any, any, any, any>, AEff>(
		...
		[Eff] extends [never]
			? never
			: [Eff] extends [Yieldable<infer _S, infer _A, infer E, infer _R>]
				? E
				: never,
		[Eff] extends [never]
			? never
			: [Eff] extends [Yieldable<infer _S, infer _A, infer _E, infer R>]
				? R
				: never
	>;
 ...
 */
export const services: <R = never>() => Effect<
...
export const fn: fn.Traced &
	((name: string, options?: SpanOptionsNoTrace) => fn.Traced) = internal.fn;
...
export const withTxState = <A, E, R>(
	...
	flatMap(Transaction.asEffect(), (state) => internalCall(() => f(state)));
...
export declare namespace Effectify {
	type Callback<E, A> = (err: E, a?: A) => void;
