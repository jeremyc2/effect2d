...
export const make: (params: {
	...
	>(
		...
		// Pre-resolve pending tool approvals before calling the LLM
		const preResolvedStreamParts: Array<Response.StreamPart<Tools>> = [];
...
export function generateText(
	...
	return Effect.flatMap(Effect.service(LanguageModel), (model) =>
...
export function streamText(
	options: GenerateTextOptions<any>,
): Stream.Stream<Response.StreamPart<any>, AiError.AiError, LanguageModel> {
