 ...
 */
export const Persisted = ServiceMap.Reference<boolean>(
 ...
 * @category Annotations
 */
export const Uninterruptible = ServiceMap.Reference<
	boolean | "client" | "server"
>("effect/cluster/ClusterSchema/Uninterruptible", { defaultValue: constFalse });
 ...
 * @category Annotations
 */
export const ClientTracingEnabled = ServiceMap.Reference<boolean>(
