 ...
 */
export class Identifier extends ServiceMap.Service<Identifier, string>()(
 ...
 * @category annotations
 */
export class Title extends ServiceMap.Service<Title, string>()(
 ...
 * @category annotations
 */
export class Version extends ServiceMap.Service<Version, string>()(
 ...
 * @category annotations
 */
export class Description extends ServiceMap.Service<Description, string>()(
 ...
 * @category annotations
 */
export class License extends ServiceMap.Service<License, OpenAPISpecLicense>()(
 ...
 * @category annotations
 */
export class ExternalDocs extends ServiceMap.Service<
	ExternalDocs,
 ...
 * @category annotations
 */
export class Servers extends ServiceMap.Service<
	Servers,
 ...
 * @category annotations
 */
export class Format extends ServiceMap.Service<Format, string>()(
 ...
 * @category annotations
 */
export class Summary extends ServiceMap.Service<Summary, string>()(
 ...
 * @category annotations
 */
export class Deprecated extends ServiceMap.Service<Deprecated, boolean>()(
 ...
 * @category annotations
 */
export class Override extends ServiceMap.Service<
	Override,
 ...
 * @category annotations
 */
export const Exclude = ServiceMap.Reference<boolean>(
...
const servicesPartial = <
	Tags extends Record<
		string,
		ServiceMap.Key<any, any> | ServiceMap.Key<never, any>
	>,
>(
	tags: Tags,
): ((
