 ...
 * @category models
 */
export class UnrecognizedOption extends Schema.ErrorClass(
 ...
 * @category models
 */
export class DuplicateOption extends Schema.ErrorClass(
 ...
 * @category models
 */
export class MissingArgument extends Schema.ErrorClass(
 ...
 * @category models
 */
export class UnknownSubcommand extends Schema.ErrorClass(
