 ...
 * @category References
 */
export const MaxParts = ServiceMap.Reference<number | undefined>(
 ...
 * @category References
 */
export const MaxFieldSize = ServiceMap.Reference<FileSystem.SizeInput>(
 ...
 * @category References
 */
export const MaxFileSize = ServiceMap.Reference<
	FileSystem.SizeInput | undefined
>("effect/http/Multipart/MaxFileSize", { defaultValue: () => undefined });

/**
 * @since 4.0.0
 * @category References
 */
export const FieldMimeTypes = ServiceMap.Reference<ReadonlyArray<string>>(
