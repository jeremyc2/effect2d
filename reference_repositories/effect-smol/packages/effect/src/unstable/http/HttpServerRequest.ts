...
import { type HttpMethod, hasBody } from "./HttpMethod.ts";
import {
	HttpServerError,
	type RequestError,
	RequestParseError,
...
>(
	...
	return Effect.flatMap(HttpServerRequest.asEffect(), (req) =>
...
>(
	...
	const parse = Schema.decodeUnknownEffect(schema);
	return Effect.flatMap(ParsedSearchParams.asEffect(), (params) =>
