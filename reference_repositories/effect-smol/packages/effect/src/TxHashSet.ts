 ...
 */
export const empty = <V = never>(): Effect.Effect<
	TxHashSet<V>,
	never,
	Effect.Transaction
> =>
...
export const fromIterable = <V>(
	values: Iterable<V>,
): Effect.Effect<TxHashSet<V>, never, Effect.Transaction> =>
	Effect.gen(function* () {
...
export const add: {
	<V>(
		value: V,
	): (self: TxHashSet<V>) => Effect.Effect<void, never, Effect.Transaction>;
	<V>(
		self: TxHashSet<V>,
		value: V,
...
export const remove: {
	<V>(
		value: V,
	): (self: TxHashSet<V>) => Effect.Effect<boolean, never, Effect.Transaction>;
	<V>(
		self: TxHashSet<V>,
		value: V,
...
export const union: {
	<V1>(
		...
		self: TxHashSet<V0>,
	) => Effect.Effect<TxHashSet<V1 | V0>, never, Effect.Transaction>;
	<V0, V1>(
		self: TxHashSet<V0>,
		that: TxHashSet<V1>,
...
export const toHashSet = <V>(
	self: TxHashSet<V>,
): Effect.Effect<HashSet.HashSet<V>, never, Effect.Transaction> =>
	TxRef.get(self.ref);
