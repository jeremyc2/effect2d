...
): Effect.Effect<TxChunk<A>, never, Effect.Transaction> =>
 ...
 * ```
 */
export const empty = <A = never>(): Effect.Effect<
	TxChunk<A>,
	never,
	Effect.Transaction
...
export const modify: {
	...
	): (self: TxChunk<A>) => Effect.Effect<R, never, Effect.Transaction>;
	<A, R>(
		self: TxChunk<A>,
...
export const get = <A>(
	self: TxChunk<A>,
): Effect.Effect<Chunk.Chunk<A>, never, Effect.Transaction> =>
	TxRef.get(self.ref);
...
export const take: {
	(
		n: number,
	): <A>(self: TxChunk<A>) => Effect.Effect<void, never, Effect.Transaction>;
	<A>(
		self: TxChunk<A>,
		n: number,
	): Effect.Effect<void, never, Effect.Transaction>;
