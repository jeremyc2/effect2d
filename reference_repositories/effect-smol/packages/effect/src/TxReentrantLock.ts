...
export const readLock = (
	...
	Effect.acquireRelease(Effect.transaction(acquireRead(self)), () =>
...
export const writeLock = (
	...
	Effect.acquireRelease(Effect.transaction(acquireWrite(self)), () =>
