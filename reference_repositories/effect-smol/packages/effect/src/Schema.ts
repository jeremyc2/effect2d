...
export declare namespace Codec {
	 ...
	 * @since 4.0.0
	 */
	export type ToAsserts<S extends Top & { readonly DecodingServices: never }> =
 ...
 * @since 4.0.0
 */
export function decodeUnknownExit<
	S extends Top & { readonly DecodingServices: never },
>(schema: S) {
 ...
 * @since 4.0.0
 */
export function encodeUnknownExit<
	S extends Top & { readonly EncodingServices: never },
>(schema: S) {
...
export function flip<S extends Top>(
	schema: S,
): S extends flip<infer F> ? F["~rebuild.out"] : flip<S>;
...
export interface Undefined
	extends Bottom<undefined, undefined, never, never, AST.Undefined, Undefined> {
	readonly "~rebuild.out": this;
}
...
export declare namespace Struct {
	...
	} & { [K in Exclude<M, O>]: F[K]["Type"] } & { [K in M & O]?: F[K]["Type"] };
	...
	} & { [K in Exclude<M, O>]: F[K]["Iso"] } & { [K in M & O]?: F[K]["Iso"] };
...
export function ArrayEnsure<S extends Top>(schema: S): ArrayEnsure<S> {
	return Union([schema, Array(schema)]).pipe(
		decodeTo(
			Array(toType(schema)),
			Transformation.transform({
				decode: Arr.ensure,
...
>(
	defaultValue: (
		...
		| Option_.Option<S["~type.make.in"]>
		| Effect.Effect<Option_.Option<S["~type.make.in"]>>,
) {
 ...
 * @since 4.0.0
 */
export interface withDecodingDefaultKey<S extends Top>
	extends decodeTo<S, optionalKey<toEncoded<S>>> {}
 ...
 * @since 4.0.0
 */
export interface withDecodingDefault<S extends Top>
	extends decodeTo<S, optional<toEncoded<S>>> {}
...
export function tag<Tag extends AST.LiteralValue>(literal: Tag): tag<Tag> {
	return Literal(literal).pipe(
		withConstructorDefault(() => Option_.some(literal)),
	);
}
...
export function tagDefaultOmit<Tag extends AST.LiteralValue>(literal: Tag) {
	return tag(literal).pipe(
		withDecodingDefaultKey(() => literal, { encodingStrategy: "omit" }),
	);
}
	...
	>(
		...
		function match() {
			if (arguments.length === 1) {
				...
				return (value: any) => cases[value[tag]](value);
			}
...
export function Opaque<Self, Brand = {}>() {
	return <S extends Top>(
		schema: S,
	): Opaque<Self, S, Brand> & Omit<S, "Type"> => {
...
export const DurationFromNanos: DurationFromNanos = BigInt.check(
	isGreaterThanOrEqualToBigInt(0n),
...
type AddStaticMembers<C, Static> = C &
 ...
 * @since 4.0.0
 */
export interface ExtendableClass<
	Self,
	S extends Top & { readonly fields: Struct.Fields },
	Inherited,
...
>(
	...
	return class extends Inherited {
		...
		declare static readonly "~rebuild.out": decodeTo<
			declareConstructor<Self, S["Encoded"], readonly [S], S["Iso"]>,
			S
		>;
		declare static readonly "~annotate.in": Annotations.Bottom<
			Self,
			readonly [S]
		>;
 ...
 * @since 4.0.0
 */
export const TaggedClass: <Self, Brand = {}>(
	identifier?: string,
) => {
 ...
 * @since 4.0.0
 */
export const ErrorClass: <Self, Brand = {}>(
	identifier: string,
) => {
	<const Fields extends Struct.Fields>(
		fields: Fields,
 ...
 * @since 4.0.0
 */
export const TaggedErrorClass: <Self, Brand = {}>(
	identifier?: string,
) => {
	<Tag extends string, const Fields extends Struct.Fields>(
		tag: Tag,
...
export function toCodecStringTree<T, E, RD, RE>(
	...
	if (options?.keepDeclarations === true) {
		return make(
			toCodecEnsureArray(serializerStringTreeKeepDeclarations(schema.ast)),
		);
	} else {
 ...
 * @since 4.0.0
 */
export function resolveInto<S extends Top>(
	schema: S,
): S["~annotate.in"] | undefined {
...
export declare namespace Annotations {
	...
	export namespace ToArbitrary {
		 ...
		 * @since 4.0.0
		 */
		export type Declaration<T, TypeParameters extends ReadonlyArray<Top>> = (
