...
export const reasonAnnotations: <E>(
	self: Reason<E>,
) => ServiceMap.ServiceMap<never> = effect.reasonAnnotations;
 ...
 * @since 4.0.0
 */
export const annotations: <E>(self: Cause<E>) => ServiceMap.ServiceMap<never> =
 ...
 * @since 4.0.0
 */
export class StackTrace extends ServiceMap.Service<StackTrace, StackFrame>()(
 ...
 * @since 4.0.0
 */
export class InterruptorStackTrace extends ServiceMap.Service<
