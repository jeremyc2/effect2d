...
export const MockTerminal = ServiceMap.Service<
	Terminal.Terminal,
	MockTerminal
...
export const columns: Effect.Effect<number, never, Terminal.Terminal> =
	Effect.flatMap(MockTerminal.asEffect(), (terminal) => terminal.columns);
...
export const readLine: Effect.Effect<
	...
	Terminal.QuitError,
	Terminal.Terminal
> = Effect.flatMap(MockTerminal.asEffect(), (terminal) => terminal.readLine);

export const inputKey = (
	key: string,
	modifiers?: Partial<MockTerminal.Modifiers>,
): Effect.Effect<void, never, Terminal.Terminal> =>
	Effect.flatMap(MockTerminal.asEffect(), (terminal) =>
		terminal.inputKey(key, modifiers),
	);
