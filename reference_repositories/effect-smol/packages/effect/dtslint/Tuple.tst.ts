...
describe("Tuple", () => {
	describe("get", () => {
		it("errors", () => {
			when(pipe).isCalledWith(
				tuple,
				expect(Tuple.get).type.not.toBeCallableWith(4),
			);
			expect(Tuple.get).type.not.toBeCallableWith(tuple, 4);

			when(pipe).isCalledWith(
				optionalTuple,
				expect(Tuple.get).type.not.toBeCallableWith(0),
			);
	...
	describe("pick", () => {
		it("errors", () => {
			when(pipe).isCalledWith(
				tuple,
				expect(Tuple.pick).type.not.toBeCallableWith([4]),
			);
	...
	describe("omit", () => {
		it("errors", () => {
			when(pipe).isCalledWith(
				tuple,
				expect(Tuple.omit).type.not.toBeCallableWith([4]),
			);
	...
	describe("renameIndices", () => {
		it("errors", () => {
			when(pipe).isCalledWith(
				tuple,
				expect(Tuple.renameIndices).type.not.toBeCallableWith(["4", "0"]),
			);
